  ...
  return (
    <Navbar className="fluid rounded border-b-2">
      ...
      <div className='flex gap-4 md:order-2'>
        ...
        <Link to={"/sign-in"}>
        <Button className='text-black-500 bg-gradient-to-r from-purple-400 to-blue-500 w-16 h-10 items-center'>Sign In</Button>
        </Link>
        <Navbar.Toggle/>
      </div>
      <NavbarCollapse >
        <NavbarLink  as={'div'} className='text-black-500 mr-4'>
          <Link to={"/"}>Home</Link>
        </NavbarLink>
